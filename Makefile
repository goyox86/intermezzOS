...
target/kernel.bin: target/multiboot_header.o target/boot.o src/asm/linker.ld cargo
	/Users/goyox86/opt/bin/x86_64-pc-elf-ld -n -o target/kernel.bin -T src/asm/linker.ld target/multiboot_header.o target/boot.o target/x86_64-unknown-intermezzos-gnu/release/libintermezzos.a
...
target/os.iso: target/kernel.bin src/asm/grub.cfg
	...
	/Users/goyox86/opt/bin/grub-mkrescue -o target/os.iso target/isofiles
